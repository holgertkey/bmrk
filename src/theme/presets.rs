...
fn gruvbox_theme() -> ThemeConfig {
    ThemeConfig {
        ...
        error_color: Some("#83a598".to_string()),    // bright blue (same as directory)
...
fn nord_theme() -> ThemeConfig {
    ThemeConfig {
        ...
        error_color: Some("#81a1c1".to_string()),    // frost blue (same as directory)
...
fn tokyonight_theme() -> ThemeConfig {
    ThemeConfig {
        ...
        error_color: Some("#7dcfff".to_string()),          // cyan (same as directory)
...
fn dracula_theme() -> ThemeConfig {
    ThemeConfig {
        ...
        error_color: Some("#8be9fd".to_string()),          // cyan (same as directory)
...
fn obsidian_theme() -> ThemeConfig {
    ThemeConfig {
        ...
        error_color: Some("#8b9dff".to_string()),    // light blue (same as directory)
